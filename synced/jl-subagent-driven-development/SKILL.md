---
name: jl-subagent-driven-development
...
digraph when_to_use {
    ...
    "jl-subagent-driven-development" [shape=box];
    "jl-executing-plans" [shape=box];
    ...
    "Partner chose inline, or no subagent tool?" -> "jl-executing-plans" [label="yes"];
    "Partner chose inline, or no subagent tool?" -> "jl-subagent-driven-development" [label="no"];
}
```
...
digraph process {
    ...
    "Dispatch final code reviewer (../jl-requesting-code-review/code-reviewer.md)" [shape=box];
    "Final findings? ONE fix dispatch, one scoped re-review, adjudicate residuals" [shape=box];
    "Final review clean: delete this plan's workspace" [shape=box];
    "Use jl-finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "More tasks remain?" -> "Dispatch final code reviewer (../jl-requesting-code-review/code-reviewer.md)" [label="no"];
    "Dispatch final code reviewer (../jl-requesting-code-review/code-reviewer.md)" -> "Final findings? ONE fix dispatch, one scoped re-review, adjudicate residuals";
    "Final findings? ONE fix dispatch, one scoped re-review, adjudicate residuals" -> "Final review clean: delete this plan's workspace";
    "Final review clean: delete this plan's workspace" -> "Use jl-finishing-a-development-branch";
}
```
...
jl-using-git-worktrees to create one or verify the existing one.
...
jl-requesting-code-review's
[code-reviewer.md](../jl-requesting-code-review/code-reviewer.md). Point it at
...
jl-finishing-a-development-branch presents the options.
...
Use jl-finishing-a-development-branch.
...
Done! Using jl-finishing-a-development-branch.
```
