...
- You have a plan from jl-writing-plans and your human partner
...
Prefer jl-subagent-driven-development when your human partner
...
The workspace and ledger are shared with jl-subagent-driven-development
...
- Each plan owns a workspace: at skill start, run
  `../jl-subagent-driven-development/scripts/sdd-workspace PLAN_FILE` — it
...
**REQUIRED SUB-SKILL:** load jl-test-driven-development now,
...
order under jl-test-driven-development, loaded at setup. A test
...
**REQUIRED SUB-SKILL:** jl-verification-before-completion governs
...
Run `../jl-subagent-driven-development/scripts/review-package PLAN_FILE MERGE_BASE HEAD`
...
[code-reviewer.md](../jl-requesting-code-review/code-reviewer.md), with the
...
```
You: I'm using the jl-executing-plans skill to implement this plan inline.
...
Using jl-finishing-a-development-branch.
```
