...
- Architectural: the human partner reviews and approves the written spec,
  ...
  written-spec approval only permits invoking jl-writing-plans.
...
- **Architectural** — new projects, new subsystems, changes that
  ...
  design, written spec, then the jl-writing-plans skill.
...
invoke after brainstorming is jl-writing-plans — never frontend-design,
